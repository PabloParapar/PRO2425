...
public class Ejercicio28 {
    ...
    public static void ejercicio28(Scanner entrada) {
        ...
        Escribir un método que simule el lanzamiento de dos dados.
        El método recibirá un número por parámetro y devolverá true cuando los dos dados devuelvan dicho número.
        Invoca el método un millón de veces y calcular el porcentaje de veces que los dos dados obtienen el número indicado:
    ...
    public static boolean lanzarDosDados(int valorDados) {
        ...
        return dado1 == dado2 && dado1 == valorDados;
    }
}