...
*/
        ...
        double masa30 = 50;     //en gramos
        double energia;         // en ergios
        ...
        int celsius;
        int farenheit;
        float convertirACelsius;
        float convertirAFarenheit;
        farenheit = 86;
        celsius = 33;
        ...
        float notaEvaluacion1;
        float notaEvaluacion2;
        float notaEvaluacion3;
        float notaMediaEvaluacion;
        ...
        int estudiantesMujer = 3;
        int estudiantesHombre = 22;
        int totalEstudiantes = estudiantesHombre + estudiantesMujer;
        ...
        double presupuestoGinecologia = presupuestoAnual * 40 / 100;
        double presupuestoPediatria = presupuestoAnual * 30 / 100;
        double presupuestoTraumatologia = presupuestoAnual * 30 / 100;
        ...
        int precioCompra = 4587;
        int precioVenta = precioCompra * 130 / 100;
        ...
        int sueldoFijo = 1134;
        int ventas = 30000;
        int comision = ventas * 5 / 100;
        int dietas = 25 * 30;
        int seguridadSocial = 150;
        double kilometraje = 25 * 100 * 0.19; // 25 días al mes hace 100km de trayecto
        double sueldoBruto = sueldoFijo + comision + dietas + kilometraje;
        double irpf = sueldoBruto * 19 / 100;
