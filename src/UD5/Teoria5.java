...
public class Teoria5 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //Llamaremos a un array con la forma 'FiguraGeometrica[] figuras = new FiguraGeometrica[5];

        FiguraGeometrica [] figuras = new FiguraGeometrica[5];  //Cuando creamos un Array en Java definimos su tamaño
